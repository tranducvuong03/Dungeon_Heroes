...
local chestOptions = {
    ...
    {Name = "Nightmare Necklace", ID = "NightmareNecklaceChest", Color = Color3.fromRGB(70, 70, 150)}
}
...
local function fireChestRemote()
    pcall(function()
        -- Dùng Remote từ code cũ của bạn
...
print("GUI Updated with NightmareNecklaceChest!")
